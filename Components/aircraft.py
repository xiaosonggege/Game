...
class AircraftProperty:
    ...
    def __set__(self, instance, value):
        if self._name == '_ImageOfAircraft':
            ...
            instance.__dict__['_RectBoarderOfScreen'] = instance.__dict__[self._name].get_rect()
            instance.__dict__['_rect'].centerx = instance.__dict__['_RectBoarderOfScreen'].centerx
            instance.__dict__['_rect'].bottom = instance.__dict__['_RectBoarderOfScreen'].bottom
...
class Aircraft:
    def __init__(self, screen:pygame.Surface):
        ...
        self._RectBoarderOfScreen = self._screen.get_rect() #屏幕矩形框Rect
        self._rect = self._ImageOfAircraft.get_rect() #飞行器矩形框Rect

        self._rect.centerx = self._RectBoarderOfScreen.centerx #飞行器矩形框中心位置横标与屏幕矩形框中心位置横标相等
        self._rect.bottom = self._RectBoarderOfScreen.bottom #飞行器矩形框底端与屏幕矩形框底端相等
